...
If you have docker installed and are running in a bash environment, the simplest way to get started is to execute the bash script `run.bash`. Alternatively you can run the development docker containers with `docker-compose up`. Either way you can then access the front-end at http://localhost:3000.
